...
public abstract class Rental implements Billing {
    ...
    protected int rentalID;  //property ID
    ...
    protected Date rentStart = new Date();  //when did the lease start

    //constructor
    public Rental(int rentalID, float rentAmt, int lease, String location, int beds, int renterID, Date rentStart) {
